...
OBJECTFILES_DEBUG+=$(OBJ_DEBUG_DIR)$(PATH_SEP)Win95Socket$(FILE_SUFFIX).o
OBJECTFILES_RELEASE+=$(OBJ_RELEASE_DIR)$(PATH_SEP)Win95Socket$(FILE_SUFFIX).o

DEPENDENCIES_4=src$(PATH_SEP)Win95Socket.bas src$(PATH_SEP)Win95Socket.bi src$(PATH_SEP)Win95Hack.bi

$(OBJ_DEBUG_DIR)$(PATH_SEP)Win95Socket$(FILE_SUFFIX).c: $(DEPENDENCIES_4)
$(OBJ_RELEASE_DIR)$(PATH_SEP)Win95Socket$(FILE_SUFFIX).c: $(DEPENDENCIES_4)
...
DEPENDENCIES_5=src$(PATH_SEP)WinMain.bas src$(PATH_SEP)WinMain.bi src$(PATH_SEP)Base64.bi src$(PATH_SEP)Registry.bi src$(PATH_SEP)Resources.RH src$(PATH_SEP)Win95Hack.bi
...
DEPENDENCIES_6=src$(PATH_SEP)Resources.RC src$(PATH_SEP)app.ico src$(PATH_SEP)Layout.RH src$(PATH_SEP)Resources.RH src$(PATH_SEP)manifest.xml
